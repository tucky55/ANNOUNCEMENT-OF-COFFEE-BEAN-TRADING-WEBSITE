...
<?php  include 'menu_user.php'?>  
    <div class="container">
        <div class="row">
            ...
            <hr>
            <form name="form1" method="post" action="notification_of_payment_db.php?bill_id=<?php echo $_GET['bill_id']; ?>" enctype="multipart/form-data">
                    ...
                    <input type= "date" name= "payment_slip" class= "form-control" placeholder= "00-00-0000" ><br>
